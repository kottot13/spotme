...
- 📍 **Route by coordinates** — type `/sm 41.8 66.6` (decimal commas and `41.8,66.6` work too), or use the coordinate field at the bottom of the party panel with its **Go** / **Clear** buttons. The field always shows the current target.
...
the arrow** or the **Clear route** button that appears on the open map. A route also clears itself
once you arrive — the distance is adjustable in the options, or you can switch it off — and when you
travel to another continent. The trail is fully
