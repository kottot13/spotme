...
local L = {
    ...
    HELP_PARTY      = "party: party | button | navcolor/dotcolor <color>  (right-click a member / Shift+click the map to route)",
    ...
    NAVCOL_LBL      = "Arrow color",
    NAVCOL_TIP      = "Color of the navigation arrow",
    ...
    NAVCOL_PINK     = "Pink",
    NAVCOL_SET      = "color: %s",
    NAVCOL_FMT      = "color: class|red|cyan|green|yellow|black|white|pink",
...
if GetLocale() == "ruRU" then
    ...
    L.HELP_PARTY      = "пати: party | button | navcolor/dotcolor <цвет>  (ПКМ по игроку / Shift+клик по карте — маршрут)"
    ...
    L.NAVCOL_LBL      = "Цвет стрелки"
    L.NAVCOL_TIP      = "Цвет стрелки навигации"
    ...
    L.NAVCOL_PINK     = "Розовый"
    L.NAVCOL_SET      = "цвет: %s"
    L.NAVCOL_FMT      = "color: class|red|cyan|green|yellow|black|white|pink"
